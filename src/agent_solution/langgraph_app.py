...
from agent_solution.graph import build_chat_graph, build_graph
...
_llm, _kb, _tools = _build_runtime()

graph = build_graph(_llm, _kb, _tools)
chat_graph = build_chat_graph(_llm, _kb, _tools)
